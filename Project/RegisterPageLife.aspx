<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterPageLife.aspx.cs" Inherits="Project.RegisterPageLife" %>
  ...
  <form id="form1" runat="server">
    <div>
        ...
        <asp:CheckBoxList ID="CheckBoxList1" runat="server" style="z-index: 1; left: 536px; top: 1096px; position: absolute; height: 28px; width: 96px">
            ...
            <asp:ListItem Selected="True">Life</asp:ListItem>
        </asp:CheckBoxList>
